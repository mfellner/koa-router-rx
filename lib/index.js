...
export default class RxRouter extends Router {
  ...
  registerEpic<B>(method: HTTPMethod, nameArg: string, pathArg: any) {
    const nameWasSupplied = typeof pathArg === 'string' || pathArg instanceof RegExp;
    const restArgsStartIndex = nameWasSupplied ? 3 : 2
    const path = nameWasSupplied ? pathArg : nameArg
    const name = nameWasSupplied ? nameArg : undefined
